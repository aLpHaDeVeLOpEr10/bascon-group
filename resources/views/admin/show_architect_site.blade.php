...
@section('content')
<x-page-header title="Architecture Sites"
               subtitle="Personal and company architecture projects." />
            ...
            <div class="ui-card" data-collapsed="0">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane " id="add_company_architect">
                                <div class="ui-card-body">
                                    <table id="show_site_company" width="100%" style="white-space: nowrap;" class="ui-table">
                                        <thead>
    ...
    <label for="field-1" class="ui-label">Plot No</label>
                                <input type="text" class="ui-input" name="name" id="field-1" placeholder="Plot No" required>
    ...
    <label for="field-1" class="ui-label">Price</label>
                                ...
                                <input type="text" class="ui-input" name="architect_fees" id="total_price" placeholder="Price" required>
</div>
                            <div class="mb-4 space-y-1.5">
    <label for="field-1" class="ui-label">Sector</label>
                                <input type="text" class="ui-input" name="sector" id="sector" placeholder="Sector" required>
