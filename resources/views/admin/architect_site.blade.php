...
<x-page-header :title="$name"
               subtitle="Architecture project detail, payments and instalments." />
            ...
            <div class="ui-card" style="padding-bottom: 30px;">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="A_category">
                                <form role="form" id="brick_addition_form" action="{{ url('admin_setting/Add_brick') }}">
                            ...
                            <div role="tabpanel" class="tab-pane" id="B_category">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="ui-total my-5" id="total_price_managments">
                                        <h4>Total Fee:@money($total_fee)</h4><h4>Total Instalments:@money($total_instalments)</h4><h4>Remaing Ammount: {{ $remaing_instalment }}</h4>
                                    </div>
                                </div>
