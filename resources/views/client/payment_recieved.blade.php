                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="b_categoer_table2342" width="100%" class="table table-bordered">
...
<script>
            ...
            buttons: [{
                    ...
                    customize: function(win) {
                        ...
                        $(win.document.body).find('table').prepend('<tfoot><tr><td ></td><td >Total Payments: {{ $total_payments }}  </td><td ></td><td ></td></tr></tfoot>');
                    }
                },
                {
                    extend: 'excel',
